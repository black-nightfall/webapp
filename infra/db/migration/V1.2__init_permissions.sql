...
-- 产品管理模块
(0, '产品管理', 'product', '/products', NULL, 'M', 3),
(12, '查看产品', 'product:read', NULL, 'product:read', 'F', 1),
(12, '创建产品', 'product:create', NULL, 'product:create', 'F', 2),
(12, '更新产品', 'product:update', NULL, 'product:update', 'F', 3),
(12, '删除产品', 'product:delete', NULL, 'product:delete', 'F', 4),

-- 订单管理模块
(0, '订单管理', 'order', '/orders', NULL, 'M', 4),
(17, '查看订单', 'order:read', NULL, 'order:read', 'F', 1),
(17, '创建订单', 'order:create', NULL, 'order:create', 'F', 2),
(17, '更新订单', 'order:update', NULL, 'order:update', 'F', 3),
(17, '删除订单', 'order:delete', NULL, 'order:delete', 'F', 4),
